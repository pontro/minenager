                    ...
                    <div class="installed-card-main">
                        ...
                        <div class="installed-card-details">
                            <div class="installed-card-name" style="font-size: 1rem;">
                                ...
                                ${p.is_whitelisted ? '<span class="installed-badge" style="background: #27272a; color: #a1a1aa; border: 1px solid #3f3f46; margin-left: 0.35rem; font-size: 0.7rem;">Whitelist</span>' : ''}
                            </div>
                        </div>
                    </div>
